...
func word_from_0(x int, y int, previous_string string, used_x []int, used_y []int) int {
	...
	wg.Add(8)
	go word_from_0(x, y+1, current_string, new_used_x, new_used_y)
	go word_from_0(x+1, y, current_string, new_used_x, new_used_y)
	go word_from_0(x+1, y+1, current_string, new_used_x, new_used_y)
